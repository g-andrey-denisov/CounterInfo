...
WELCOME = (
    ...
    "  /reading — показания на дату\n"
    "  /period — посуточный отчёт (до 90 дней)\n"
    "  /monthly — помесячный отчёт (до 5 лет)\n"
    "  /help — эта справка\n\n"
    "Вместо команд можно писать ключевые слова: <b>Блокнот</b>, <b>Очисти</b>, "
