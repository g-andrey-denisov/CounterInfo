...
| `/reading`, `Показания` | Показания счётчика на указанную дату |
| `/period`, `Период` | Показания счётчика за период (до 90 дней, по суткам) |
| `/monthly`, `Месяцы` | Помесячный отчёт (до 5 лет) |
